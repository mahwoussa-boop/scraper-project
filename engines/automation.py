...
class GlobalAutomationManager:
    ...
    def _execute_full_cycle(self, sitemap_urls, our_file_path):
        ...
        def scraper_progress(msg, p):
            ...
            self.progress = p * 0.5 # الكشط يمثل 50% من العملية
        ...
        # 3. المقارنة (Analysis)
        self.current_status = "🤖 جاري المقارنة الذكية..."
        self.progress = 0.6
